...
export default function Project({ projectId, onBack }) {
  ...
  const renderActiveStage = () => {
    ...
    switch (activeStage) {
      ...
      case 4.5: return <Stage045Gate project={project} onComplete={() => { handleStageComplete(); setActiveStage(5); }} />;
      case 5: return <Stage05Design project={project} stageData={getStageData(project, 5)} onComplete={handleStageComplete} onContinue={() => setActiveStage(6)} />;
